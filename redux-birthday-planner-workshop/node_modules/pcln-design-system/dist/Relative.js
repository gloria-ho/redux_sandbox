...
var top = (0, _styledSystem.responsiveStyle)({
  prop: 'top',
  cssProperty: 'top',
  numberToPx: true
});

var bottom = (0, _styledSystem.responsiveStyle)({
  prop: 'bottom',
  cssProperty: 'bottom',
  numberToPx: true
});

var left = (0, _styledSystem.responsiveStyle)({
  prop: 'left',
  cssProperty: 'left',
  numberToPx: true
});

var right = (0, _styledSystem.responsiveStyle)({
  prop: 'right',
  cssProperty: 'right',
  numberToPx: true
});
...
var Relative = (0, _styledComponents2.default)(_Box2.default)(_templateObject, top, bottom, left, right, zIndex);
