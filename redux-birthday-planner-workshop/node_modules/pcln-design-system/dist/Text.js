...
exports.italic = exports.bold = exports.regular = exports.caps = undefined;
...
var italic = exports.italic = function italic(props) {
  return props.italic ? { fontStyle: 'italic' } : null;
};

var align = (0, _styledSystem.responsiveStyle)('text-align', 'align');

var Text = _styledComponents2.default.div(_templateObject, italic, _styledSystem.fontSize, _styledSystem.space, _styledSystem.color, caps, regular, bold, align);
